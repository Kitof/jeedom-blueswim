...
<div class="row row-overflow">
	...
	<div class="col-xs-12 eqLogicThumbnailDisplay">
		...
		<?php
		if (count($eqLogics) == 0) {
			echo '<br/><div class="text-center" style="font-size:1.2em;font-weight:bold;">{{Aucun équipement Blueriiot n\'est disponible.<br/>Configurer vos identifiants et cliquer sur "Synchroniser" pour commencer}}</div>';
		} else {
			// Champ de recherche
			...
			foreach ($eqLogics as $eqLogic) {
				...
				echo '<img src="plugins/blueswim/core/images/' . $eqLogic->getConfiguration('device') . '.jpg"/>';
				echo '<br>';
						...
						<div class="col-lg-6">
							<legend><i class="fas fa-info"></i> {{Informations}}</legend>
                                                        <fieldset>
                                                                ...
                                                                <label class="col-sm-3 control-label">{{Modèle}}</label>
                                                                  <div class="col-sm-8">
                                                                    <select class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="device">
                                                                        <option value="bluego">bluego</option>
                                                                        <option value="bluego_premium">bluego_premium</option>
                                                                        <option value="blueplus">blueplus</option>
                                                                    </select>
                                                                  </div>
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-sm-3 control-label">{{Numéro de série Blue}}</label>
                                                                <div class="col-sm-3">
                                                                    <span class="eqLogicAttr label label-default" data-l1key="configuration" data-l2key="blue_serial"></span>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="text-center">
                                                                    <img id="img_device" name="img_device" src="plugins/blueswim/plugin_info/bluerriot.jpg" style="max-width:160px;"/>
                                                                </div>
                                                            </div>
                                                            <br/>
                                                        </fieldset>
...
<?php include_file('desktop', 'blueswim', 'js', 'blueswim');?>
